...
#bg {
  ...
  width: 100%;
  height: 100%;
  background: url(http://www.interactive.com.tn/img/full-slider/full-slide2.jpg) no-repeat center center fixed;
...
<form method="post" action="<%=request.getContextPath()%>/Controller" >
  ...
  <button type="submit" value=submit>login to your account</button>
...
<script>
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyDEjXB9pp0lPPmWvW0y33cygOWMX3UuyjI",
    authDomain: "appcode-fcbb9.firebaseapp.com",
    databaseURL: "https://appcode-fcbb9.firebaseio.com",
    storageBucket: "appcode-fcbb9.appspot.com",
    messagingSenderId: "568407648966"
  };
